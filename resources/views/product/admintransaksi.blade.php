...
<div class="btn-group-horizontal">
    ...
    <button class="btn btn-primary status" id="delivered">On Progress</button>
          ...
          <tbody>
            ...
            <tr> 
              <td>
                ...
                @endphp
                      <span class="label label-warning">Sisa Waktu Pembayaran: {{$tenggat->h}} Jam, {{$tenggat->i}} Menit</span>
