...
<html lang="en">
<head>
<title>Product | MakeUpBeauty</title>
					...
					<div class="row">
						<div class="col">
							<div class="home_content">
								<div class="home_title">PRODUK 100% ORIGINAL!<span>.</span></div>
								<div class="home_text"><p>No BOKIS</p></div>
							</div>
						</div>
					</div>
				</div>
				...
				<div class="col">
					...
					<div class="product_grid">
						...
						<div class="product">
							...
							<div class="product_image"><img src="/uploads/product_images/{{$jpg->image_name}}" alt=""></div>
							
							<div class="product_extra product_new"><a href="categories.html">New</a></div>
							<div class="product_content">
								<div class="product_title"><a href="2">Oriflame Brush</a></div>
