...
<html lang="en">
<head>
<title>Transaction | MakeupBeauty</title>
						...
						<div class="col">
							<div class="home_content">
								<div class="breadcrumbs">
									<ul>
                    <div class="home_title" style="font-size: 30px; color:#e95a5a;">{{ Auth::user()->name }}'s Transaction</div>
										<li><a href="/home" style="font-size: 25px">Home</a></li>
                    @auth
                    <li><a href="/transaksi/{{Auth::user()->id}}" style="font-size: 25px">Transaction</a></li>
                    @endauth
			...
			<div class="row">
                ...
                @endphp
                    ...
                    @elseif ($transaksi->status == 'delivered')
                      <span style="color: white;" class="badge badge-primary">Sedang dikirim</span>
                    @else 
