...
<html lang="en">
<head>
<title>Checkout | MakeUpBeauty</title>
            ...
            <table class="table product-table">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  @endphp
                  @if ($hasil != 0)
                         <td>Rp. <span class="float-lef grey-text price{{$loop->iteration-1}}">{{number_format($hasil)}}</li>
                          Rp. <span class="float-lef grey-text"><small><s>{{number_format($item->price)}}</s></small></span>
                        </td>
                  @else
                          <td>Rp. <span class="float-lef grey-text price{{$loop->iteration-1}}">{{number_format($item->price)}}</li></td>
                  @endif
                  ...
                  @if ($hasil != 0)
                         <td>Rp. <span class="float-lef grey-text price{{$loop->iteration-1}}">{{number_format($hasil)}}</li>
                          Rp. <span class="float-lef grey-text"><small><s>{{number_format($item->product->price)}}</s></small></span></td>
                  @else
                          <td>Rp. <span class="float-lef grey-text price{{$loop->iteration-1}}">{{number_format($item->product->price)}}</li></td>
                  @endif
                  <td class="text-center text-md-left">
