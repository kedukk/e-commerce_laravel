							...
							<div class="row">
								<div class="col">
									<div class="home_slider_content"  data-animation-in="fadeIn" data-animation-out="animate-out fadeOut">
										<div class="home_slider_title" style="color:black; background-color: rgba(255, 255, 255, 0.5)">MakeUpBeauty</div>
										<div class="home_slider_subtitle" style="color:black; background-color: rgba(255, 255, 255, 0.5)">Rasakan sensasi berbelanja menyenangkan hanya di MakeUpBeauty</div>
									</div>
								</div>
							</div>
						</div>
					...
					<div class="home_slider_content_container">
						<div class="container">
							<div class="row">
								<div class="col">
									<div class="home_slider_content"  data-animation-in="fadeIn" data-animation-out="animate-out fadeOut">
										<div class="home_slider_title">#RIBETLESS</div>
										<div class="home_slider_subtitle">Dapatkan segera produk kecantikan yang Anda inginkan</div>
										<div class="button button_light home_button"><a href="#">Shop Now</a></div>
									</div>
								</div>
							</div>
			...
			<div class="avds_small">
				...
				<div class="avds_small_inner">
					...
					<div class="avds_small_content">
						<div class="avds_title" style="background-color: rgba(0, 0, 0, 0.5)">Brush</div>
						<div class="avds_text" style="background-color: rgba(0, 0, 0, 0.5)">Jangan lewatkan #passthebrushchallenge</div>
			...
			<div class="avds_large">
				...
				<div class="avds_large_container">
					<div class="avds_large_content">
						<div class="avds_title">MUA Profesional</div>
						<div class="avds_text">Wujudkan mimpimu untuk ikut serta dalam #LATHICHALLENGE</div>
					</div>
				</div>
			</div>
		</div>
