...
Route::get('/ongkir', 'CheckoutController@submit');
...
Route::prefix('admin')->group(function(){
    ...
    // Tambahan
    Route::get('/transaksi/{id}', 'AdminTransactionController@index');
    Route::get('/transaksi', 'AdminTransactionController@adminIndex');
    Route::get('/transaksi/detail', 'AdminTransactionDetailController@adminIndex');
    Route::get('/transaksi/detail/{id}', 'AdminTransactionDetailController@adminIndex');
    Route::post('/transaksi/detail/proof', 'AdminTransactionDetailController@uploadProof');
    Route::post('/transaksi/sort', 'AdminTransactionController@sort');
    Route::post('/transaksi/detail/status', 'AdminTransactionDetailController@membatalkanPesanan');
...
Route::post('/admin/transaksi/sort', 'AdminTransactionController@sort');
Route::post('/report-bulan', 'AdminTransactionController@filterBulan');
Route::post('/report-tahun', 'AdminTransactionController@filterTahun');
Route::post('/grafik', 'AdminTransactionController@grafik');
